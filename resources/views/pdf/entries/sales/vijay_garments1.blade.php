...
<table width="100%" class="print:*">
    <tr>
        <td colspan="7" style="text-align: center; margin-top: 2px; font-weight: bold; border-right: none;">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            Tax&nbsp;Invoice&nbsp;</td>
        <td colspan="1" style="text-align: right; margin-top: 2px; font-weight: bold; border-left: none">Original
            Copy
        </td>
    </tr>
...
{{--    company details--}}
    ...
    <tr>
        ...
        <td colspan="3" style="border: none;">
            <div style="text-align: left;font-weight: bold;">{{$cmp->get('company_name')}}</div>
...
{{--    buyer details--}}
    ...
    <tr>
        ...
        <td colspan="2" style="text-align: center;">
            <div><span>&nbsp;&nbsp;Dispatch Date&nbsp;</span></span>
            </div>
        </td>
    </tr>
    <tr>
...
<table width="100%" class="print:*">
    <tr>
        <td colspan="7" style="text-align: center; margin-top: 2px; font-weight: bold; border-right: none;">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            Tax&nbsp;Invoice&nbsp;</td>
        <td colspan="1" style="text-align: right; margin-top: 2px; font-weight: bold; border-left: none">Duplicate
            Copy
        </td>
    </tr>
...
<table width="100%" class="print:*">
    <tr>
        <td colspan="7" style="text-align: center; margin-top: 2px; font-weight: bold; border-right: none;">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            Tax&nbsp;Invoice&nbsp;</td>
        <td colspan="1" style="text-align: right; margin-top: 2px; font-weight: bold; border-left: none">Office
            Copy
        </td>
    </tr>
