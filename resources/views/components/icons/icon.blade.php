...
<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" xmlns="http://www.w3.org/2000/svg" {{$attributes}}>
    ...
    @switch($icon)
        ...
        @case('heart')
            <path stroke="#000000" d="M12 7.4564V6.3723M12 6.6545C12 3.5542 14.5124 1.0418 17.6127 1.0418S23.2255 3.5884 23.2255 6.6888C23.2255 8.3565 22.4899 9.9548 21.2156
