...
<li class="flex align-center flex-col cursor-pointer">
    ...
    <div
        @click="selected !== 25 ? selected = 25 : selected = null"
        class="relative flex flex-row justify-between items-center h-11 focus:outline-none hover:bg-gray-700
                        ...
                        <span class="inline-flex justify-center items-center ml-4">
                            <x-icons.icon :icon="'utilities'" class="w-5 h-auto block"/>
                             <x-menu.header>Utilities</x-menu.header>
                        </span>

        <span class="inline-flex justify-center items-center">
                        <svg fill="currentColor" viewBox="0 0 20 20"
                             :class="{'rotate-0': selected ==null, 'rotate-180': selected === 25}"
    ...
    <div x-show="selected === 25" class="p-1 flex flex-col">

        <ul class="grid-cols-1 grid bg-gray-800">

            @include('components.menu.items.utilities-menu')
