<div>
    <x-slot name="header">Hsncode</x-slot>
    ...
    <x-forms.m-panel>
        ...
        <x-forms.table :list="$list">
            <x-slot name="table_header">
                ...
                <x-table.ths-center wire:click.prevent="sortBy('vname')">Hsncode</x-table.ths-center>
        ...
        <x-forms.create :id="$vid">
            <x-input.model-text wire:model="vname" :label="'Hsncode'"/>
        </x-forms.create>
