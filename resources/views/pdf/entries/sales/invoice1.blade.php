...
{{--    </tr>--}}
    ...
    <tr>
        ...
        <td colspan="8" align="center" style="border-bottom: none;border-top: none;">Total</td>
    ...
    <tr>
        ...
        <td align="center">Rate</td>
        <td align="center">Amount</td>
        <td colspan="8" align="center" style="border-top: none;">Tax Amount</td>
    ...
    <tr>
        ...
        <td align="center" style="border-bottom: none; "></td>
        <td align="center" style="border-bottom: none; ">{{$obj->total_gst/2}}</td>
        <td colspan="8" align="center" style="border-bottom: none;">{{$obj->total_gst}}</td>
...
{{--    </tr>--}}
    ...
    <tr>
        ...
        <td colspan="8" style="height: 40px; text-align: center; vertical-align: top; padding-top: 5px ">
