<div>
    ...
    <x-forms.m-panel>
        ...
        <div class="lg:w-1/2 px-8">
            ...
            <button wire:click="addItems" class="px-3 bg-green-500 text-white font-semibold tracking-wider ">Add Address
            </button>
        </div>
        </div>
        ...
        @if ($itemList)
            ...
            @foreach($itemList as $index => $row)
                ...
                <div class="grid w-full grid-cols-2 pt-6"  wire:click.prevent="changeItems({{$index}})">
                    ...
                    <label class="px-3 pb-2 text-right text-gray-800 text-md">{{$row->address_1}}</label>
                </div>
                <div class="grid w-full grid-cols-2 pt-6"  wire:click.prevent="changeItems({{$index}})">
                    <label class="px-3 pb-2 text-left text-gray-600 text-md">Area-Road</label>
                    <label class="px-3 pb-2 text-right text-gray-800 text-md">{{$row->address_2}}</label>
                </div>
                <div class="grid w-full grid-cols-2 pt-6"  wire:click.prevent="changeItems({{$index}})">
                    <label class="px-3 pb-2 text-left text-gray-600 text-md">City</label>
                    <label class="px-3 pb-2 text-right text-gray-800 text-md">{{$row->city_name}}</label>
                </div>
                <div class="grid w-full grid-cols-2 pt-6"  wire:click.prevent="changeItems({{$index}})">
                    <label class="px-3 pb-2 text-left text-gray-600 text-md">State</label>
                    <label class="px-3 pb-2 text-right text-gray-800 text-md">{{$row->state_name}}</label>
                </div>
                <div class="grid w-full grid-cols-2 pt-6"  wire:click.prevent="changeItems({{$index}})">
                    <label class="px-3 pb-2 text-left text-gray-600 text-md">Pin Code</label>
                    <label class="px-3 pb-2 text-right text-gray-800 text-md">{{$row->pincode_name}}</label>
                </div>
                <div class="grid w-full grid-cols-2 pt-6"  wire:click.prevent="changeItems({{$index}})">
                    <label class="px-3 pb-2 text-left text-gray-600 text-md">Country</label>
                    <label class="px-3 pb-2 text-right text-gray-800 text-md">{{$row->country_name}}</label>
                </div>
                <div class="grid w-full grid-cols-2 pt-6"  wire:click.prevent="changeItems({{$index}})">
                    <label class="px-3 pb-2 text-left text-gray-600 text-md">GSt</label>
                    <label class="px-3 pb-2 text-right text-gray-800 text-md">{{$row->gstin}}</label>
                </div>
                <div class="grid w-full grid-cols-2 pt-6"  wire:click.prevent="changeItems({{$index}})">
                    <label class="px-3 pb-2 text-left text-gray-600 text-md">Email</label>
                    <label class="px-3 pb-2 text-right text-gray-800 text-md">{{$row->email}}</label>
                </div>
            @endforeach
        @endif
