    ...
    <x-forms.m-panel>
        ...
        <!-- ref_id ---------------->
            ...
            @if($vmode == 'payment')
                ...
                @if($cashbills)
                    ...
                    @livewire('controls.lookup.accounts.cashbill-lookup',[$cashbill_id])
        ...
        <!-- paidby ---------------->
            ...
            <input type="text" wire:model="paidby" id="paidby" autofocus
                   class="purple-textbox @error('paidby') ? purple-textbox  : red-textbox @enderror"
                   placeholder="Paid by"/>
        ...
        <!-- credit ---------------->
            ...
            @if($vmode == 'receipt')
                ...
                <input type="text" wire:model="receipt" id="receipt"
                       class="purple-textbox @error('receipt') ? purple-textbox  : red-textbox @enderror"
                       placeholder="Receipt"/>
            ...
            @elseif($vmode == 'payment')
                ...
                <input type="text" wire:model="payment" id="payment"
                       class="purple-textbox @error('payment') ? purple-textbox  : red-textbox @enderror"
                       placeholder="Payment"/>
