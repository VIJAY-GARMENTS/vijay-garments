<div>
    <x-slot name="header">Section Inward Note</x-slot>
    <x-forms.m-panel>
        ...
        <x-forms.table>
            <x-slot name="table_header">
                ...
                <x-table.ths-center wire:click.prevent="sortBy('vno')">Action</x-table.ths-center>
            </x-slot>
            <x-slot name="table_body">
                @forelse ($list as $index =>  $row)
                    <x-table.row>
                        ...
                        <x-table.cell>
                            <a href="{{route('sectioninwards.upsert',[$row->id])}}"
